...
def runControlLoops():
    ...
    scanSimState = scanSimControl.ScanSimState(70, 10)        # scanSimState (scanRange, turnSpeed)
    ...
    statsController  = plumbing.controlloop.ControlLoop( statsState,  statsControl.statsControlUpdate, 0.06 * timeScale,  0.06 * timeScale)
    ...
    rcChanController.connectTo(statsController, rcChanControl.rcChanToStatsTranslator)
    odoController.connectTo(statsController, odoControl.odoToStatsTranslator)
